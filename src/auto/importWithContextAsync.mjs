...
import {
    ...
    fs$removeSyncFactory                       as fs$removeSyncFactory,
...
export default async function importWithContextAsync(plugs = {}, new_context = null) {
    ...
    let library = {
        ...
        fs$removeSync                           : await fs$removeSyncFactory(null, library_context),
        fs$removeSyncFactory                    : fs$removeSyncFactory,
    ...
    library.dict = {
        ...
        "fs/removeSync.mjs"                     : library["fs$removeSync"],
        "fs/removeSyncFactory.mjs"              : library["fs$removeSyncFactory"],
