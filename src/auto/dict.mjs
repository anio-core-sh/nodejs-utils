...
import {
    ...
    fs$removeDirectorySync                 as u,
    fs$removeDirectorySyncFactory          as v,
    fs$removeFileSync                      as w,
    fs$removeFileSyncFactory               as x,
    fs$removeSync                          as y,
    fs$removeSyncFactory                   as z,
...
export default {
    ...
    "fs/removeDirectorySync.mjs"            : u,
    "fs/removeDirectorySyncFactory.mjs"     : v,
    "fs/removeFileSync.mjs"                 : w,
    "fs/removeFileSyncFactory.mjs"          : x,
    "fs/removeSync.mjs"                     : y,
    "fs/removeSyncFactory.mjs"              : z,
